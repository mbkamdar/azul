...
if __name__ == "__main__":
    import setup_azul
    from factory_offer import factory_offer
    ...
    print(player1.name)
    print("Next round starter:", player1.starter)
    print("Score:", player1.score)
    print("Wall:")
    for x in player1.wall: print(x)

    print(player2.name)
    print("Next round starter:", player2.starter)
    print("Score:", player2.score)
    print("Wall:")
    for x in player2.wall: print(x)
